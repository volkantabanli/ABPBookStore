...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 91ca93f3-8556-4af5-b73e-e4f34ece1be0
```

> `91ca93f3-8556-4af5-b73e-e4f34ece1be0` is the password of the certificate, you can change it to any password you want.
