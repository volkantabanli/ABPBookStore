...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c4d8c414-9e77-47e2-89de-07a3167bcba1
```

> `c4d8c414-9e77-47e2-89de-07a3167bcba1` is the password of the certificate, you can change it to any password you want.
